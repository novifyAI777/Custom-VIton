...
- **Stage 2** → VITON-HD Virtual Try-On
- **Stage 3** → PIFuHD 3D Reconstruction
...
- Higher quality → better segmentation
...
### ❗ SCHP parsing is inaccurate
Body parts must be fully visible.

### ❗ YOLO Pose misses joints
Ensure entire person is in frame.

### ❗ Cloth extraction faulty
